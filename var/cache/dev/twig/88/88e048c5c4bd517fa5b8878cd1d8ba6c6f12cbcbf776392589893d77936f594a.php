...
class __TwigTemplate_45d1643bd1ad627758a95a35f778f10b35ae7a198cc2e7ddf86b9ba10d53cbf0 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 13
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 13, $this->source); })()), "categorieName", [], "any", false, false, false, 13), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "categorie/show.html.twig", "C:\\Users\\louay\\Documents\\GitHub\\ArtBox-CrashTest-WEB\\templates\\categorie\\show.html.twig");
    }
}
