 ...
 */
class getSignalisationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SignalisationRepository' shared autowired service.
     *
     * @return \App\Repository\SignalisationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SignalisationRepository.php';

        return $container->privates['App\\Repository\\SignalisationRepository'] = new \App\Repository\SignalisationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
