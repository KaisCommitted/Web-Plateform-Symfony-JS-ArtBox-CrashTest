 ...
 */
class getInteractionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InteractionsRepository' shared autowired service.
     *
     * @return \App\Repository\InteractionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InteractionsRepository.php';

        return $container->privates['App\\Repository\\InteractionsRepository'] = new \App\Repository\InteractionsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
