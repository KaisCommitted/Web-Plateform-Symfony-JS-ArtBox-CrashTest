 ...
 */
class getRatingEventRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RatingEventRepository' shared autowired service.
     *
     * @return \App\Repository\RatingEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RatingEventRepository.php';

        return $container->privates['App\\Repository\\RatingEventRepository'] = new \App\Repository\RatingEventRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
