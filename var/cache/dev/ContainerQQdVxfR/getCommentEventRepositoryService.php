 ...
 */
class getCommentEventRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommentEventRepository' shared autowired service.
     *
     * @return \App\Repository\CommentEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommentEventRepository.php';

        return $container->privates['App\\Repository\\CommentEventRepository'] = new \App\Repository\CommentEventRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
