...
//            die();
    ...
    public function getEvent(EvenementRepository $EvenementRepository, SerializerInterface $serializerInterface)
    {
        ...
        $json = $serializer->normalize($E , 'json', [AbstractNormalizer::ATTRIBUTES => ['id','nomEvent','description','date','imageEvent','typeEvent'=>['typeName'],'categorie'=>['categorieName'],'idOrg'=>['username']]]);
