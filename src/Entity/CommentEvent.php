 ...
 * CommentEvent
 *
 * @ORM\Table(name="comment_event", indexes={@ORM\Index(name="userr", columns={"id_user"}), @ORM\Index(name="eventt", columns={"id_event"})})
...
class CommentEvent
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="commentDate", type="date", nullable=false, options={"default"="CURRENT_TIMESTAMP"})
     */
